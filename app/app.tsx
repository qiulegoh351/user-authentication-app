...
import tamaguiConfig from './theme/tamagui/tamagui.config';
...
export function App() {
  ...
  // ensures initAppState only runs once
  ...
  const toastTopOffset = useMemo(() => {
    return (
      ...
      DEFAUL_HEADER_HEIGHT +
      getTokens()?.space?.$screenPadding?.val
    );
  }, []);
  ...
  useEffect(() => {
    ...
    if (!ready || hasBootstrappedRef.current) return;
    hasBootstrappedRef.current = true;
    initAppState();
  }, [isNavigationStateRestored, isI18nInitialized, areFontsLoaded, fontLoadError, initAppState]);
            ...
            <BottomSheetModalProvider>
              <AuthProvider>
                <ThemeProvider>
                  ...
                  <Toast topOffset={toastTopOffset} config={toastConfig} />
                </ThemeProvider>
              </AuthProvider>
            </BottomSheetModalProvider>
